...
<title>The Making Of VentStatus / Images from Development</title>
...
<div id="wrapper">
	<div id="header">
		...
		<div id="menu">
            ...
            <a href="archive.php" class="sel">History</a>			                                                
        ...
        <div id="main_content" class="with_sidebar">
        	...
        	<div id="archive">
            	...
            	<div id="logo_1" class="image">
                	<a href="images/archive/logo_1.jpg" rel="lightbox[archive]" title="First Ventstatus logo"><img src="images/archive/thumbs/logo_1.gif" alt="The first ventstatus logo"/></a>
       	    ...
       	    <div id="timeline_1" class="image">
               	  <a href="images/archive/timeline_1.gif" rel="lightbox[archive]" title="Yes, this is honestly an important part of ventstatus development"><img src="images/archive/thumbs/timeline_1.gif" alt="An early sketch of the ventstatus timeline" /></a>
                    <h4>Yes, this is honestly an important part of ventstatus development</h4>
                    <p>Sometimes you just need a picture to get your ideas together. Normally you can jot down ideas like this before you even start storing data. This idea however, came about when I was looking through loads of data I already had, and suddenly had this radical idea of presenting it through a timeline. I quickly opened up MSPaint and planned out what is now one of the coolest features of Ventstatus.</p>
            </div>
            
				<div id="site_1" class="image">
                	<a href="images/archive/site_1.jpg" rel="lightbox[archive]" title="Early in development, basic timeline and bar graph"><img src="images/archive/thumbs/site_1.gif" alt="The ventstatus.com prototype" /></a>
				...
				<div id="site_2" class="image">
                	<a href="images/archive/site_2.jpg" rel="lightbox[archive]" title="Now we look like a site"><img src="images/archive/thumbs/site_2.gif" alt="Ventstatus.com styled" /></a>
				...
				<div id="timeline_2" class="image">
                	<a href="images/archive/timeline_2.jpg" rel="lightbox[archive]" title="Fisher price timeline"><img src="images/archive/thumbs/timeline_2.gif" alt="A large and early version of a vernstatus timeline" /></a>
				...
				<div id="timeline_3" class="image">
                	<a href="images/archive/timeline_3.jpg" rel="lightbox[archive]" title="Its Christmas at Ventstatus"><img src="images/archive/thumbs/timeline_3.gif" alt="A smaller, more colorful timeline" /></a>
  				...
  				<div id="site_3" class="image">
                	<a href="images/archive/site_3.jpg" rel="lightbox[archive]" title="Finally starting to shape up"><img src="images/archive/thumbs/site_3.gif" alt="A nice and polishedventstatus.com" /></a>
				...
				<div id="timeline_4" class="image">
                	<a href="images/archive/timeline_4.jpg" rel="lightbox[archive]" title="The timeline hardhat area"><img src="images/archive/thumbs/timeline_4.gif" alt="The timeline under development as it looks now" /></a>
